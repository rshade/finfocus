...
// Test Engine.GetRecommendationsForResources filters dismissed IDs.
func TestEngine_GetRecommendationsForResources_ExcludedIDs(t *testing.T) {
...
func TestDismissalStore_DefaultPath(t *testing.T) {
	...
	// We can't directly access the path, but we can verify the store was created
	assert.NotNil(t, store)
	_ = expectedPath // Path assertion would require exposing internal field
}
