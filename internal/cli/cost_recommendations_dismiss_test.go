...
func TestNewRecommendationsDismissCmd(t *testing.T) {
	...
	dismissSub := findSubcommand(cmd, "dismiss")
	assert.NotNil(t, dismissSub, "dismiss subcommand should exist")
...
func TestNewRecommendationsSnoozeCmd(t *testing.T) {
	...
	snoozeSub := findSubcommand(cmd, "snooze")
	assert.NotNil(t, snoozeSub, "snooze subcommand should exist")
...
// T015: Test direct transition Dismissed->Snoozed (FR-010a).
func TestSnoozeCmd_DirectTransitionAllowed(t *testing.T) {
	cmd := cli.NewCostRecommendationsCmd()
	snoozeSub := findSubcommand(cmd, "snooze")
	require.NotNil(t, snoozeSub)
...
// T015: Test re-snooze with updated expiry (FR-010a).
func TestSnoozeCmd_ResnoozeAllowed(t *testing.T) {
	cmd := cli.NewCostRecommendationsCmd()
	snoozeSub := findSubcommand(cmd, "snooze")
	require.NotNil(t, snoozeSub)
