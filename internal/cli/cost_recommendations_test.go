...
// T018: Test default list excludes dismissed (no --include-dismissed).
func TestCostRecommendationsCmd_DefaultExcludesDismissed(t *testing.T) {
	cmd := cli.NewCostRecommendationsCmd()

	// Default value of include-dismissed should be false
	flag := cmd.Flags().Lookup("include-dismissed")
