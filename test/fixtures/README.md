...
### Terraform State (/test/fixtures/terraform/)

Real Terraform state generated by OpenTofu and the `hashicorp/aws` provider
against a local moto emulator. `make gen-terraform-goldens` regenerates it. See
[terraform/aws-realistic/README.md](terraform/aws-realistic/README.md).
