...
- Go 1.26.5 with `github.com/Masterminds/semver/v3` and finfocus plugin SDK.
...
- Go 1.26.5 + finfocus-spec SDK, Cobra CLI, zerolog, gRPC, pluginsdk (001-plugin-init-recorder)
- Local filesystem for fixture downloads and recorded request output (001-plugin-init-recorder)

### Recent Changes

- 001-plugin-init-recorder: Added Go 1.26.5 + finfocus-spec SDK, Cobra CLI, zerolog, gRPC, pluginsdk
