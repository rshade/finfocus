...
// This file specifies the configuration structures.
//
// Location: specs/126-multi-plugin-routing/contracts/config.go
// Implementation: internal/config/routing.go
...
// Used for type-safe feature handling until finfocus-spec#287 is resolved.
type Feature string

const (
	// FeatureProjectedCosts enables projected cost estimation.
	FeatureProjectedCosts Feature = "ProjectedCosts"

	// FeatureActualCosts enables historical cost retrieval.
	...
	// FeatureCarbon enables carbon footprint estimation.
	FeatureCarbon Feature = "Carbon"

	// FeatureDryRun enables dry run simulation.
	FeatureDryRun Feature = "DryRun"

	// FeatureBudgets enables budget tracking.
